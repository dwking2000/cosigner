package io.emax.cosigner.ethereum.token.gethrpc.tokencontract.v3;
...
import io.emax.cosigner.ethereum.token.gethrpc.tokencontract.v2.TokenContractParametersV2;
...
public class TokenContractParametersV3 extends TokenContractParametersV2 {
  private static final Logger LOGGER = LoggerFactory.getLogger(TokenContractParametersV3.class);

  @Override
  public Long getNonce(EthereumRpc ethereumRpc, String contractAddress) {
    TokenContractV3 contract = new TokenContractV3();
  ...
  public String rebuildAdminFunction(Map<String, List<String>> params) {
    ...
    String result;
    switch (function) {
      case TokenContractV3.createTokens:
        ...
        break;
      case TokenContractV3.destroyTokens:
        result = destroyTokens(new BigInteger(params.get(NONCE).get(0)).longValue(),
            params.get(PARAM + 0).get(0),
            new BigInteger(1, ByteUtilities.toByteArray(params.get(PARAM + 1).get(0))).longValue(),
            params.get(SIGV), params.get(SIGR), params.get(SIGS));
        break;
      case TokenContractV3.setTokenContract:
        ...
        break;
      case TokenContractV3.reconcile:
  ...
  private List<String> parseArray(int bufPointer, String buffer, boolean decodeToInt,
    ...
    arrayPointer += new TokenContractV3().getTransfer()
