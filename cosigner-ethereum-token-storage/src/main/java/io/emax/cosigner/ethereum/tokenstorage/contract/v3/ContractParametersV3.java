package io.emax.cosigner.ethereum.tokenstorage.contract.v3;
...
import io.emax.cosigner.ethereum.tokenstorage.contract.v2.ContractParametersV2;
...
import static io.emax.cosigner.ethereum.tokenstorage.contract.ContractInterface.ValueParam;

public class ContractParametersV3 extends ContractParametersV2 {
  ...
  private List<String> parseArray(int bufPointer, String buffer, boolean decodeToInt,
    ...
    arrayPointer +=
        new ContractV3().getTransfer().length(); // Offset by function id, not included in calc.
