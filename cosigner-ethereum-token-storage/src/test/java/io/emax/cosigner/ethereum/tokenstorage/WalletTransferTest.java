...
public class WalletTransferTest {
  private static final Logger LOGGER = LoggerFactory.getLogger(WalletTransferTest.class);
  ...
  public void createTransfer() {
    try {
      ...
      io.emax.cosigner.api.currency.Wallet.Recipient recipient =
          new io.emax.cosigner.api.currency.Wallet.Recipient();
      ...
      LOGGER.debug(null, e);
      Assert.fail("Problem issuing transfer");
    }
  }
