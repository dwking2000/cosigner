...
public class DecodedTransaction {
	...
	public String toString() {
		return "DecodedTransaction [transactionId=" + transactionId + ", version=" + version + ", locktime=" + locktime
    ...
    /**
     * An object describing one of this transaction’s inputs. 
     * May be a regular input or a coinbase
     */
    public static class DecodedInput extends Outpoint {
        ...
        /**
         * The coinbase (similar to the hex field of a scriptSig) encoded as hex. 
        ...
        @Override
		public String toString() {
			return "DecodedInput [scriptSig=" + scriptSig + ", coinbase=" + coinbase + ", sequence=" + sequence + "]";
		}
    ...
    public static class ScriptPubKey {
         ...
         * (including P2SH multisig because the redeem script is not available in the pubkey script). 
         * It may be greater than 1 for bare multisig. 
         * This value will not be returned for nulldata or nonstandard script types (see the type key below)
         */
        ...
        /**
         * The P2PKH or P2SH addresses used in this transaction, or the computed P2PKH address of any pubkeys 
         * in this transaction. 
        ...
        @Override
		public String toString() {
			return "ScriptPubKey [asm=" + asm + ", hex=" + hex + ", requiredSignatures=" + requiredSignatures
					+ ", scriptType=" + scriptType + ", addresses=" + addresses + "]";
		}
