...
public class Payment {
     ...
     * 
     * vout, Added in Bitcoin Core 0.10.0
     ...
     * Because inputs list the output indexes from previous transactions, more than one entry in 
     * the details array may have the same output index
     */
    @JsonUnwrapped
     ...
     * May be 0. Not returned if receiving payment
     */
    @JsonProperty("fee")
     ...
     * Not returned for regular transactions
     */
    ...
    /**
     * Only returned for confirmed transactions. 
     * The block height of the block on the local best block chain which includes 
     * this transaction
     */
    ...
    /**
     * Only returned for confirmed transactions. The block header time (Unix epoch time) of 
     * the block on the local best block chain which includes this transaction
     */
    @JsonProperty("blocktime")
    private Date blockTime;

    /**
     * An array containing the TXIDs of other transactions that spend the same inputs (UTXOs) 
     * as this transaction. Array may be empty
     * 
    ...
    /**
     * A Unix epoch time when the transaction was detected by the local node, or the time of 
     * the block on the local best block chain that included the transaction
     */
    ...
    /**
     * For transaction originating with this wallet, a locally-stored comment added to the 
     * transaction identifying who the transaction was sent to. Only returned if a comment-to 
     * was added
     */
    @JsonProperty("to")
    private String to;
	...
	public String toString() {
		return "Payment [watchOnlyAddress=" + watchOnlyAddress + ", account=" + account + ", address=" + address
				+ ", category=" + category + ", amount=" + amount + ", output=" + output + ", fee=" + fee
				+ ", confirmations=" + confirmations + ", generated=" + generated + ", blockHash=" + blockHash
				+ ", blockHeight=" + blockHeight + ", blockTime=" + blockTime + ", conflictingTransactionIds="
				+ conflictingTransactionIds + ", time=" + time + ", received=" + received + ", comment=" + comment
				+ ", to=" + to + "]";
	}
