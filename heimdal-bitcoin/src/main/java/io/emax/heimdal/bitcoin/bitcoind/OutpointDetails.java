...
public class OutpointDetails {
	...
	/**
	 * Optional If the pubkey script was a script hash, this must be the
	 * corresponding redeem script
	 */
	...
	public OutpointDetails(String transactionId, long outputIndex, String scriptPubKey, String redeemScript) {
	...
	public String toString() {
		return "OutpointDetails [transactionId=" + transactionId + ", outputIndex=" + outputIndex + ", scriptPubKey="
				+ scriptPubKey + ", redeemScript=" + redeemScript + "]";
	}
