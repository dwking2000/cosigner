...
public class AddressReceived {
     ...
     * 
     * Set to true if this address is a watch-only address which has received a spendable payment (that is, a payment with at least the 
     * specified number of confirmations and which is not an immature coinbase). Otherwise not returned
     */
	...
	public String toString() {
		return "AddressReceived [involvesWatchonly=" + involvesWatchonly + ", address=" + address + ", account="
				+ account + ", amount=" + amount + ", confirmations=" + confirmations + ", transactionIds="
				+ transactionIds + "]";
	}
