...
public class Outpoint {
	...
	/**
	 * The output index number (vout) of the outpoint; the first output in a
	 * transaction is index 0
	 */
	@JsonProperty("vout")
	...
	public String toString() {
		return "Outpoint [transactionId=" + transactionId + ", outputIndex=" + outputIndex + ", address=" + address
				+ ", account=" + account + ", scriptPubKey=" + scriptPubKey + ", redeemScript=" + redeemScript
				+ ", amount=" + amount + ", confirmations=" + confirmations + ", spendable=" + spendable + "]";
	}
