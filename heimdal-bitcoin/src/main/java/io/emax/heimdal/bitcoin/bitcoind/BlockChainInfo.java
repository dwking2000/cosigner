...
public class BlockChainInfo {
     ...
     * For a new node with just the hardcoded genesis block, this will be 0
     */
    @JsonProperty("blocks")
    private long blocks;
     ...
     * For a new node with just the hardcoded genesis block, this will be zero. This number may be higher than the number of blocks
     */
    @JsonProperty("headers")
    private long headers;

    /**
     * The hash of the header of the highest validated block in the best block chain, encoded as hex in RPC byte order. 
     * This is identical to the string returned by the getbestblockhash RPC
     */
     ...
     * May slightly exceed 1.0 when fully synced to account for transactions in the memory pool which have been 
     * verified before being included in a block
     */
