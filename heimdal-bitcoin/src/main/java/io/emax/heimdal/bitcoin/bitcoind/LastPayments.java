...
public class LastPayments {
     ...
     * The objects in this array do not describe an actual transactions, so more than one object in this array 
     * may come from the same transaction. This array may be empty
     * 
