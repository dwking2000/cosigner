...
public class Block {
    ...
    /**
     * The number of confirmations the transactions in this block have, starting at 1 when this block is at the tip of the best block chain. 
	...
	public String toString() {
		return "Block [blockHash=" + blockHash + ", confirmations=" + confirmations + ", size=" + size + ", height="
				+ height + ", version=" + version + ", merkleRoot=" + merkleRoot + ", transactionIds=" + transactionIds
				+ ", time=" + time + ", nonce=" + nonce + ", bits=" + bits + ", difficulty=" + difficulty
				+ ", chainwork=" + chainwork + ", previousBlockHash=" + previousBlockHash + ", nextBlockHash="
				+ nextBlockHash + "]";
	}
