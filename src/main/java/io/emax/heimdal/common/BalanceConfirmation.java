...
/**
 * POJO for representing confirmations of balances. Timestamp is intended to be
 * msecs since epoch for simplicity.
 */
public class BalanceConfirmation {
    ...
    public String toString() {
        return "BalanceConfirmation [timestamp=" + timestamp + ", blockNumber=" + blockNumber + ", blockHash="
                + blockHash + "]";
    }
}
