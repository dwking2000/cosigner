...
public class Transactor {
    ...
    public String coinbase() throws IOException {
        if (Objects.equals(coinbase.get(), ""))
            coinbase.set(new Gson()
                    .fromJson(JSONRPC2.Call(uri, "eth_coinbase"), Properties.class)
                    .getProperty("result"));
        return coinbase.get();
    }
     ...
     * @throws IOException
     */
    public String createContract(Contract contract, BigInteger gasPrice)
            throws IOException {
        List<Map<String, String>> params = singletonList(
    ...
    public String gasPriceAsHex() throws IOException {
        return new Gson()
                .fromJson(JSONRPC2.Call(uri, "eth_gasPrice"), Properties.class)
                .getProperty("result");
    }
