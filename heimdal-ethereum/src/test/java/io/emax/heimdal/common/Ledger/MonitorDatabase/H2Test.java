...
import io.emax.heimdal.common.Ledger.MonitorDatabase.H2;
...
public class H2Test {
    ...
    public void testGetBalances() throws Exception {
        ...
        try (H2 testDB = new H2("TEST")) {
            ...
            String expectedJSON = "[{\"currency\":\"TEST\",\"amount\":\"9999\",\"account\":\"56abc\",\"monitored\":true,\"firstConfirmation\":{\"timestamp\":1,\"blockNumber\":1,\"blockHash\":\"ABC\"},\"lastConfirmation\":{\"timestamp\":2,\"blockNumber\":2,\"blockHash\":\"ABCD\"}}, {\"currency\":\"TEST\",\"amount\":\"8888\",\"account\":\"55aaa\",\"monitored\":true}]";
    ...
    public void testGetBalancesList() throws Exception {
        try (H2 testDB = new H2("TEST")) {
            ...
            Balance[] actual = actualList.toArray(new Balance[actualList.size()]);
            String expectedJSON = "[{\"currency\":\"TEST\",\"amount\":\"9999\",\"account\":\"56abc\",\"monitored\":true,\"firstConfirmation\":{\"timestamp\":1,\"blockNumber\":1,\"blockHash\":\"ABC\"},\"lastConfirmation\":{\"timestamp\":2,\"blockNumber\":2,\"blockHash\":\"ABCD\"}}]";
            Balance[] expected = new Gson().fromJson(expectedJSON, Balance[].class);
            Assert.assertArrayEquals(expected, actual);
            ...
            Assert.assertEquals(
                    "getBalance() for \"56ABC\" and \"55AAA\" is the same as getBalance()",
                    expected2, actual2);
        }
    }
    ...
    public void testMonitor() throws Exception {
        try (H2 testDB = new H2("TEST")) {
            List<Balance> actualList = testDB.monitor(
                    Arrays.asList("0xDEADBEEF1", "DEADBeeF2")
            );
            Balance[] actual = actualList.toArray(new Balance[actualList.size()]);
            String expectedJSON = "[" +
    ...
    public void testMonitorOldAccount() throws Exception {
        try (H2 testDB = new H2("TEST")) {
            List<Balance> actualList = testDB.monitor(
                    Arrays.asList("0xDEADBEEF1", "56abc")
            );
    ...
    public void testUpdateAccounts() throws Exception {
        try (H2 testDB = new H2("TEST")) {
            ...
            List<Balance> expected2 = Arrays.asList(new Gson().fromJson(
                    "[" +
            ...
            List<Balance> balances = Arrays.asList(new Gson().fromJson(
                    "[" +
                            "{\"currency\":\"TEST\",\"amount\":\"99999\",\"account\":\"56abc\",\"monitored\":true,\"firstConfirmation\":{\"timestamp\":1,\"blockNumber\":1,\"blockHash\":\"ABC\"},\"lastConfirmation\":{\"timestamp\":3,\"blockNumber\":3,\"blockHash\":\"FFFFAAA\"}}," +
