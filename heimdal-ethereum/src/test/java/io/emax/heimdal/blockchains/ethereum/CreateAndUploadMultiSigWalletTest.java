...
public class CreateAndUploadMultiSigWalletTest extends TestCase {
  ...
  public void testCreateAndUploadMultiSigWallet() throws Exception {
    ...
    Assert.assertEquals(
        "monitor1 can upload the newly created wallet and returns the address of said contract",
        transactor1.createContract(multiSigWalletFuture), multiSigWalletFuture.address);
  }
}
