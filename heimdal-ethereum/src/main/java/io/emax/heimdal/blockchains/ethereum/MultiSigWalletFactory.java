...
public class MultiSigWalletFactory {
    ...
    public MultiSigWalletFactory(@NotNull Transactor transactor1, @NotNull Transactor monitor2, String coldStorage) {
     ...
     */
    public MultiSigWallet makeNewMultiSigWallet() throws InterruptedException, ExecutionException, IOException {
