...
public class Solidity {
    ...
    /**
     * Compiles contract code using the solidity compiler.
     * Returns a {Future<String>} containing the compiled code.
     *
     ...
     */
    public static Future<String> compile(@NotNull String contractCode) throws IOException, InterruptedException {
