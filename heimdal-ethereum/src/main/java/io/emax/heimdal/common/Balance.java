...
public class Balance {
    ...
    public Balance(@NotNull String account,
                   String amount,
                   @NotNull String currency,
                   BalanceConfirmation firstConfirmation,
                   BalanceConfirmation lastConfirmation,
    ...
    public boolean equals(Object o) {
        ...
        if (!currency.equals(balance.currency)) return false;
        ...
        if (!monitored.equals(balance.monitored)) return false;
        if (firstConfirmation != null ? !firstConfirmation.equals(balance.firstConfirmation) : balance.firstConfirmation != null)
            return false;
        return !(lastConfirmation != null ? !lastConfirmation.equals(balance.lastConfirmation) : balance.lastConfirmation != null);
    ...
    public String toString() {
        return "Balance [currency=" + currency + ", amount=" + amount + ", account=" + account + ", monitored="
                + monitored + ", firstConfirmation=" + firstConfirmation + ", lastConfirmation=" + lastConfirmation
                + "]";
    }
}
