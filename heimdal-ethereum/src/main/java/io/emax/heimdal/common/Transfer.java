...
public class Transfer {
  ...
  public Transfer(@NotNull String to, @NotNull String from, @NotNull String amount,
      @NotNull String currency, Long counter) {
    this.to = to;
    this.from = from;
    this.amount = amount;
  ...
  public boolean equals(Object o) {
    ...
    if (!currency.equals(transfer.currency))
      return false;
    if (!to.equals(transfer.to))
      return false;
    if (!from.equals(transfer.from))
      return false;
    if (!amount.equals(transfer.amount))
      return false;
