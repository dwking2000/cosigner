...
public class MultiSigWallet implements Contract {
  ...
  public MultiSigWallet(String address, String coinbase1, String coinbase2, String coldStorage)
    ...
    contract =
        getMultiSigWalletTemplate().replaceAll("0xDEADBEEF0", getColdStorage())
            .replaceAll("0xDEADBEEF1", getCoinbase1()).replaceAll("0xDEADBEEF2", getCoinbase2());
