...
public class CurrencyParameters {
	...
	public String toString() {
		return "CurrencyParameters [currencySymbol=" + currencySymbol + ", userKey=" + userKey + ", account=" + account
				+ ", callback=" + callback + ", receivingAccount=" + receivingAccount + ", amount=" + amount
