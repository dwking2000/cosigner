...
import io.emax.cosigner.ethereum.core.common.Rlp;
import io.emax.cosigner.ethereum.core.common.RlpEntity;
...
public class RawTransaction extends RlpList {
  ...
  public static RawTransaction createContract(EthereumTransactionConfiguration config,
      String data) {
    RawTransaction tx = new RawTransaction();
