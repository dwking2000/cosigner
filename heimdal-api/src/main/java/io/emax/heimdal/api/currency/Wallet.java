...
public interface Wallet {
	 ...
	 * It's assumed the wallet will provide a way to backup the private keys 
	...
	/**
	 * Provides a multi-sig account for the given addresses. There may be additional
	 * addresses involved if provided in the currency configuration. The order of the addresses
	 * may matter depending on the currency.
	 * @param addresses 
	...
	/**
	 * Sign the provided transaction with the provided address' private keys if available
	 * Any existing signing validation should be called before calling this interface
	 * 	I.E. Amount range, transaction counts for the day, untrusted recipient, etc...
	 * @param transaction
	 * @param address
	...
	/**
	 * Sign the provided transaction, the address' private key will be generated with the provided account name. 
	 * @param transaction
	 * @param address
	 * @param name
	 * @return Same transaction with new signature data
