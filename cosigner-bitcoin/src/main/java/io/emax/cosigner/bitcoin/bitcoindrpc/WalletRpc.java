...
public interface WalletRpc {
   ...
   * @param account   The account name in which the address should be stored. Default is the
   *                  default
   ...
   *
   * <p>The getnewaddress RPC returns a new Bitcoin address for receiving payments. If an account
   * is
  ...
  void importaddress(String addressOrScript, String account,
      boolean rescan);
   ...
   *
   * @param confirmations    The minimum number of confirmations an externally-generated
   *                         transaction
   ...
   *                         calculations as if they were regular addresses belonging to the
   *                         wallet.
   ...
   *
   * @param minimumConfirmations the minimum number of confirmations an output must have The
   *                             minimum
   ...
   * @param addresses            If present, only outputs which pay an address in this array will
   *                             be
  ...
  Output[] listunspent(int minimumConfirmations,
      int maximumConfirmations, String[] addresses);
  ...
  Payment[] listtransactions(String account, int numberToReturn,
      int numberToSkip, boolean includeWatchOnly);
}
